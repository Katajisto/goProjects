...
func init() {
     ...
     templatePtr = template.Must(template.ParseFiles("/root/go/src/goProjects/portfolio/seetext.html"))
     mainTemplatePtr = template.Must(template.ParseFiles("/root/go/src/goProjects/portfolio/mainpage.html"))
/*	
